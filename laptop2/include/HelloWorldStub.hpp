...
*/
#ifndef V1_COM_EXAMPLE_HELLOWORLD_Hello_World_STUB_HPP_
#define V1_COM_EXAMPLE_HELLOWORLD_Hello_World_STUB_HPP_
...
{
public:
    typedef std::function<void (std::string _message)>sendHelloReply_t;
    ...
    /// This is the method that will be called on remote calls on the method sendHello.
    virtual void sendHello(const std::shared_ptr<CommonAPI::ClientId> _client, sendHelloReply_t _reply) = 0;
...
#endif // V1_COM_EXAMPLE_HELLOWORLD_Hello_World_STUB_HPP_
