...
*/
#ifndef V1_COM_EXAMPLE_HELLOWORLD_Hello_World_PROXY_HPP_
#define V1_COM_EXAMPLE_HELLOWORLD_Hello_World_PROXY_HPP_

#include "HelloWorldProxyBase.hpp"
...
public:
    ...
    /**
     * Calls sendHello with synchronous semantics.
     *
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void sendHello(CommonAPI::CallStatus &_internalCallStatus, std::string &_message, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * Calls sendHello with asynchronous semantics.
     *
     ...
     */
    virtual std::future<CommonAPI::CallStatus> sendHelloAsync(SendHelloAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
...
template <typename ... _AttributeExtensions>
void HelloWorldProxy<_AttributeExtensions...>::sendHello(CommonAPI::CallStatus &_internalCallStatus, std::string &_message, const CommonAPI::CallInfo *_info) {
    delegate_->sendHello(_internalCallStatus, _message, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> HelloWorldProxy<_AttributeExtensions...>::sendHelloAsync(SendHelloAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->sendHelloAsync(_callback, _info);
}
...
#endif // V1_COM_EXAMPLE_HELLOWORLD_Hello_World_PROXY_HPP_
